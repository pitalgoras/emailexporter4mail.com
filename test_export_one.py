...
""")
    ...
    # show a snippet of the saved html
    if os.path.isdir(E.HTML_DIR):
        for f in os.listdir(E.HTML_DIR):
            p = os.path.join(E.HTML_DIR, f)
            print("HTML SIZE:", f, os.path.getsize(p))
